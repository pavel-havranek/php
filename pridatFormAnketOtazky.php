...
<body>
	...
	while ($radek = mysqli_fetch_array($vysledek)) {
		?>
    <p> index otazky:
        <a href="detail.php?id=<?php echo $radek["idOtazky"]; ?>" title="Detail"><?php echo $radek["idOtazky"]; ?></a>
    ...
    <form method="POST" action="pridatFormAnketOtazky.php">

        Anketni otazka:
        <textarea name="textOtazky"></textarea>
